        ...
        <div className="bg-surface rounded-3xl border border-line shadow-sm p-6 sm:p-8 space-y-8">
          ...
          <div>
            ...
            <button
              ...
              className="mt-4 w-full bg-accent hover:bg-accent-strong text-ink font-black py-3.5 rounded-xl transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
