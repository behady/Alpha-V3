      ...
      <div className="px-8 pb-8">
        <div className="flex flex-col md:flex-row items-center md:items-end gap-6 -mt-12 mb-8 relative z-10">
            ...
            <div className="relative group">
                <div className="w-28 h-28 rounded-full border-4 border-white bg-surface-muted shadow-lg overflow-hidden flex items-center justify-center text-slate-400 relative">
            ...
            <div className="bg-surface-subtle border border-line px-4 py-2 rounded-xl flex items-center gap-2 mb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div className="relative">
                    ...
                    <input 
                        ...
                        className="w-full bg-surface-subtle border border-line focus:border-emerald-500 rounded-xl py-3 ps-12 pe-4 text-sm font-bold outline-none transition-all"
                    />
                </div>
            </div>
            ...
            <div>
                ...
                <div className="flex gap-2">
                    <select
                      ...
                      className="w-[45%] bg-surface-subtle border border-line focus:border-emerald-500 rounded-xl py-3 px-3 text-sm font-bold outline-none transition-all"
                    >
            ...
            <div>
                ...
                <div className="relative opacity-60 cursor-not-allowed">
                    ...
                    <input 
                        ...
                        className="w-full bg-surface-muted border border-line rounded-xl py-3 ps-12 pe-4 text-sm font-bold outline-none"
                    />
                </div>
            ...
            <div className="md:col-span-2">
                ...
                <textarea 
                    ...
                    className="w-full bg-surface-subtle border border-line focus:border-emerald-500 rounded-xl p-4 text-sm font-bold outline-none transition-all resize-none custom-scrollbar"
                />
            </div>
        </div>
